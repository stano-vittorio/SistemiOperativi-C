...
/// @operation calcluates the offset to the memory segment start address
...
static inline void list_head_insert_after(list_head_t * l1, list_head_t * l2)
{
    // [La]->l1  La<-[l1]->Lb    <-[l2]->    l1<-[Lb]

    list_head_t * l1_next = l1->next;
...
static inline void list_head_insert_before(list_head_t * l1, list_head_t * l2)
{
    // [La]->l1      [l2]      La<-[l1]->Lb  l1<-[Lb]

    list_head_t * l1_prev = l1->prev;
...
static inline void list_head_del(list_head_t * l)
{
    // [La]->l   La<-[l]->Lb  l<-[Lb]
...
static inline int list_head_empty(list_head_t const * head)
{
...
/// @brief Insert element l2 before l1.
static inline void list_head_add(list_head_t * entry, list_head_t * head)
{
    __list_add(entry, head, head->next);
}

/// @brief Insert element l2 before l1.
static inline void list_head_add_tail(list_head_t * entry, list_head_t * head)
{
    __list_add(entry, head->prev, head);
}

/// @brief Prints the list_head.
static inline void print_list_head(list_head_t * head) {
